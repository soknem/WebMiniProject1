...
carts2.map((cart) => {
  item.innerHTML += `
  <div class="card w-full h-auto max-w-sm bg-white border border-green-500 rounded-lg shadow p-1 pb-0 m-1 transition duration-150 ease-out transform hover:scale-105">
...
carts.map((cart) => {
  item1.innerHTML += `
  <div class="card w-full h-[100%] max-w-sm bg-white border border-green-500 rounded-lg shadow p-1 m-1 transition duration-150 ease-out transform hover:scale-105">
  <div class="img flex justify-center items-center overflow-hidden rounded-[5px] h-[40%] mb-1">
      <img class="rounded-t-lg object-cover h-full w-full" src="${cart.img}" alt="" />
  </div>
  <div class="profile flex justify-between items-center bg-green-100 text-gray-700 h-[3rem]">
